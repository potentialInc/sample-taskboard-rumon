...
> {
    ...
    async getPreferences(@CurrentUser() user: any) {
        const prefs = await this.userService.getPreferences(user.id);
        return new SuccessResponseDto(prefs, 'Preferences retrieved successfully');
    }
    ...
    async updatePreferences(@CurrentUser() user: any, @Body() body: any) {
        const prefs = await this.userService.updatePreferences(user.id, body);
        return new SuccessResponseDto(prefs, 'Preferences updated successfully');
    }
